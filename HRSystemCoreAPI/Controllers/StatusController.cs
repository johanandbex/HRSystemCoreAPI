...
namespace HRSystemCoreAPI.Controllers
{
    ...
    public class StatusController : ControllerBase
    {
        ...
        public StatusController(HRSystemCoreAPIContext context)
        {
            _context = context;
        }
        ...
        /*
        [HttpGet("GetPending")]
        public async Task<ActionResult<IEnumerable<Status>>> GetPending()
        {
            return await _context.Status.Where(s=>s.Status1=="Pending").ToListAsync();
        }
        */
